...
def print_header():
    ...
    print(colored("\n****************************************************************\n", 'red'))
    print(colored("A portable DDoS adversary simulation tool designed by students of Network Technology and Cyber Security Batch 35.\n", 'red'))
...
def vulnerability_scanner(target_ip, mitre_techniques):
    ...
    with open("vulnerability_scan.txt", "w") as scan_file:
        ...
        for vuln in vulnerabilities:
            ...
            scan_file.write(f"  Description: {vuln['description']}\n\n")
...
def display_help_menu():
    ...
    table.add_row(["1", "Network Denial of Service (DoS)", "target_ip, target_port, num_threads"])
    table.add_row(["2", "Endpoint Denial of Service (Slowloris)", "target_ip, target_port, num_sockets"])
    table.add_row(["3", "Service Exhaustion Flood", "target_ip, target_port"])
    table.add_row(["4", "Application/System Exploit", "target_ip, target_port"])
    table.add_row(["5", "Help", "Display this help menu"])
    table.add_row(["6", "About", "Display information about the tool"])
    table.add_row(["0", "Exit", "Exit the tool"])
    print(table)
    input("Press Enter to return to the main menu...")

def display_about_menu():
    os.system("clear")
    print("\nLegionnaire: A portable DDoS adversary simulation tool designed by students of Network Technology and Cyber Security.")
    print("\nThis tool was developed by the Students of NTCS Batch 35. The group members:")
    print("\n1. Khaled Naleem : Project Manager, Developer")
    print("2. Kevin Julian : Tester")
    print("3. Uditha Ishan : Researcher")
    print("4. Lakash : Researcher")
    print("5. DInushandh : Security Analyst")
    print("6. Shadee : Finance Analyst")
